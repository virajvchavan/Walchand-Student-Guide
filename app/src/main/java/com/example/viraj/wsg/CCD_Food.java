...
public class CCD_Food extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ccd__food);
        ...
        text2.setText(R.string.ccd_addr);

        TextView text3 = (TextView)(findViewById(R.id.text_3_phone_no));
        text3.setText(R.string.ccd_addr_phone);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"CCD_Food",comment);

        }
        else {
            Toast.makeText(CCD_Food.this, "Login First", Toast.LENGTH_SHORT).show();
        }
