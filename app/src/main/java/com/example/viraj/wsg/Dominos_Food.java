...
public class Dominos_Food extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dominos__food);
        ...
        text2.setText(R.string.dominos_add);

        TextView text3 = (TextView)(findViewById(R.id.text_3_phone_no));
        text3.setText(R.string.dominos_phone);
...
*/        View line=(View)(findViewById(R.id.line_3_1));
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Dominos Food",comment);

        }
        else {
            Toast.makeText(Dominos_Food.this, "Login First", Toast.LENGTH_SHORT).show();
        }
