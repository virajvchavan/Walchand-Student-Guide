...
public class AshirwadMess extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ashirwad_mess);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Ashirwad Mess",comment);
            ET_comment.setText("");
        }
        else {
            Toast.makeText(AshirwadMess.this, "Login First", Toast.LENGTH_SHORT).show();
        }
