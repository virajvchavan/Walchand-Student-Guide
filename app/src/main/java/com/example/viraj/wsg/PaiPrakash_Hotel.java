...
public class PaiPrakash_Hotel extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pai_prakash__hotel);
        ...
        text2.setText(R.string.paiprakash_add);

        TextView text3 = (TextView)(findViewById(R.id.text_3_phone_no));
        text3.setText(R.string.paiprakash_phone);
        ...
        TextView text6= (TextView)(findViewById(R.id.text_3_extraHeader));
        text6.setVisibility(View.GONE);

        TextView text7= (TextView)(findViewById(R.id.text_3_extraText));
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"PaiPrakash_Hotel",comment);

        }
        else {
            Toast.makeText(PaiPrakash_Hotel.this, "Login First", Toast.LENGTH_SHORT).show();
        }
