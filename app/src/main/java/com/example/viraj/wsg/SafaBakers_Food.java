...
public class SafaBakers_Food extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_safa_bakers__food);
        ...
        text2.setText(R.string.safa_add);

        TextView text3 = (TextView)(findViewById(R.id.text_3_phone_no));
        text3.setText(R.string.safa_phone);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"SafaBakers_Food",comment);

        }
        else {
            Toast.makeText(SafaBakers_Food.this, "Login First", Toast.LENGTH_SHORT).show();
        }
