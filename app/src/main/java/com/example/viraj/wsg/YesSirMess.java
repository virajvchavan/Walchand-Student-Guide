...
public class YesSirMess extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yes_sir_mess);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Yes Sir Mess",comment);
            ET_comment.setText("");
        }
        else {
            Toast.makeText(YesSirMess.this, "Login First", Toast.LENGTH_SHORT).show();
        }
