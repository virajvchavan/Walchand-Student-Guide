...
public class JainMess extends ExtendForEveryActivityWithDrawer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jain_mess);
        ...
        // call jsonFetch for display comments
            jsonFetch();
            showComments("Jain mess");
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Jain mess",comment);
            ET_comment.setText("");


        }
        else {
            Toast.makeText(JainMess.this,"Login First",Toast.LENGTH_SHORT).show();
        }
