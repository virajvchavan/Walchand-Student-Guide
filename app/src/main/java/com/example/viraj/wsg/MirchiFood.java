...
public class MirchiFood extends ExtendForEveryActivityWithDrawer{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mirchi_food);
        ...
        text2.setText(R.string.mirchi_add);

        TextView text3 = (TextView)(findViewById(R.id.text_3_phone_no));
        text3.setText(R.string.mirchi_phone);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Mirchi Food",comment);

        }
        else {
            Toast.makeText(MirchiFood.this, "Login First", Toast.LENGTH_SHORT).show();
        }
