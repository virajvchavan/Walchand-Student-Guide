...
public class GaneshMess extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ganesh_mess);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Ganesh Mess",comment);
            ET_comment.setText("");
            onRestart();
        }
        else {
            Toast.makeText(GaneshMess.this, "Login First", Toast.LENGTH_SHORT).show();
        }
