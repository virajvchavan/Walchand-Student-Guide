...
public class SaiMess extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sai_mess);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Sai Mess",comment);
            ET_comment.setText("");
        }
        else {
            Toast.makeText(SaiMess.this, "Login First", Toast.LENGTH_SHORT).show();
        }
