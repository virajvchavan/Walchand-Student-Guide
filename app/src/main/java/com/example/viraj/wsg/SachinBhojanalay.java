...
public class SachinBhojanalay extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sachin_bhojanalay);
        ...
        showComments("Sachin Bhojanalay");
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Sachin Bhojanalay",comment);
            ET_comment.setText("");
        }
        else {
            Toast.makeText(SachinBhojanalay.this, "Login First", Toast.LENGTH_SHORT).show();
        }
