...
public class GaneshNashta_Food extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ganesh_nashta__food);
        ...
        text2.setText(R.string.ganesh_add);

        TextView text3 = (TextView)(findViewById(R.id.text_3_phone_no));
        text3.setText(R.string.ganesh_phone);
     ...
     showComments("GaneshNashta_Food");
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"GaneshNashta_Food",comment);

        }
        else {
            Toast.makeText(GaneshNashta_Food.this, "Login First", Toast.LENGTH_SHORT).show();
        }
