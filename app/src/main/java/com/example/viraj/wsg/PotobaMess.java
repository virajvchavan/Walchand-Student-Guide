...
public class PotobaMess extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_potoba_mess);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Potoba Mess",comment);
            ET_comment.setText("");
        }
        else {
            Toast.makeText(PotobaMess.this, "Login First", Toast.LENGTH_SHORT).show();
        }
