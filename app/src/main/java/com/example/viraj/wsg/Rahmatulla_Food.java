...
public class Rahmatulla_Food extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rahmatulla__food);
        ...
        text2.setText(R.string.rahamtullah_add);

        TextView text3 = (TextView)(findViewById(R.id.text_3_phone_no));
        text3.setText(R.string.rahamtullah_phone);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Rahmatulla Food",comment);

        }
        else {
            Toast.makeText(Rahmatulla_Food.this, "Login First", Toast.LENGTH_SHORT).show();
        }
