...
public class IceBerg_Food extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ice_berg__food);
        ...
        text2.setText(R.string.ice_add);

        TextView text3 = (TextView)(findViewById(R.id.text_3_phone_no));
        text3.setText(R.string.ice_phone);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"IceBerg_Food",comment);

        }
        else {
            Toast.makeText(IceBerg_Food.this, "Login First", Toast.LENGTH_SHORT).show();
        }
