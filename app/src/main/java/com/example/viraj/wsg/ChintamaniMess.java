...
public class ChintamaniMess extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chintamani_mess);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Chintamani Mess",comment);
            ET_comment.setText("");
        }
        else {
            Toast.makeText(ChintamaniMess.this, "Login First", Toast.LENGTH_SHORT).show();
        }
