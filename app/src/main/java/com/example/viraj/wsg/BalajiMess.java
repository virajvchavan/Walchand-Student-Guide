...
public class BalajiMess extends ExtendForEveryActivityWithDrawer {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_balaji_mess);
    ...
    public void Addcomment(View view)
    {
        ...
        if (!nameFromShared.equals("N/A"))
        {
            ...
            backgroundTask.execute(method,nameFromShared,passFromShared,"Balaji Mess",comment);
            ET_comment.setText("");
        }
        else {
            Toast.makeText(BalajiMess.this, "Login First", Toast.LENGTH_SHORT).show();
        }
